...
export function UserDashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Minhas Reservas Recentes</CardTitle>
          <CardDescription>Suas últimas reservas de almoço</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoadingReservations ? (
            <div className="space-y-4">
          ...
          {myReservations && myReservations.length > 0 && (
            <div className="mt-4 flex justify-center">
              <Button variant="outline" asChild>
                <Link href="/minhas-reservas">Ver Todas as Reservas</Link>
              </Button>
            </div>
          )}
        </CardContent>
