...
const wasteReportFiltersSchema = z.object({
...
/**
 * Componente de filtros para o relatório de desperdício e cancelamentos
 ...
 * />
 */
export function WasteReportFilters({
  onFiltersChange,
  className,
  ...
  const handleFiltersChange = (updatedFilters: ReportFilters) => {
    try {
      const validatedFilters = wasteReportFiltersSchema.parse(updatedFilters);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            Selecione o período para análise de desperdício e cancelamentos
          </p>
        </div>
        {startDate && endDate && (
          <Button
        ...
        <div className="flex items-center gap-2 rounded-md border border-green-200 bg-green-50 p-3 dark:border-green-900 dark:bg-green-950/20">
          ...
          <div className="flex-1">
            ...
            <p className="text-muted-foreground text-xs">
              Pronto para gerar relatório de desperdício e cancelamentos
            </p>
          </div>
        </div>
      )}
